...
$sql = "SELECT * FROM M_SETUP_UNIT WHERE UNIT_ID = '".$WFR."'";
$query = db::query($sql);
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
					<div class="col-md-12">
						<form action="../save/setup_unit_save.php" method="POST">
							<input type="hidden" id="proc" name="proc" value="<?php echo $proc;?>">
							<input type="hidden" id="WFR" name="WFR" value="<?php echo $WFR;?>">
							 <div class="row">
								<div class="col-md-1"></div>	
								<div class="col-md-2">
									<label class="control-label">ชื่อหน่วย</label>
								</div>
								<div class="col-md-3">
									<input type="text" class="form-control" id="UNIT_NAME" name="UNIT_NAME" value="<?php echo $rec['UNIT_NAME'];?>" >
								</div>
								<div class="col-md-1"></div>	
								<div class="col-md-2">
								...
								<div class="col-md-3">
									<input type="text" class="form-control" id="UNIT_SHORT_NAME" name="UNIT_SHORT_NAME" value="<?php echo $rec['UNIT_SHORT_NAME'];?>" >
								</div>
							</div><br>							 
							<div class="row">
								<div class="col-md-1"></div>								
							 ...
							 <div class="row">
								<div class="col-md-12" align="center">
									...
									<a type="button" href="setup_unit_disp.php" class="btn btn-danger btn-sm" title="">ยกเลิก</a>
								</div> <!-- /controls -->	
							</div> 
						</form>
					</div> 
