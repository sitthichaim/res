...
$sql = "SELECT * FROM M_SETUP_PRODUCT_TYPE WHERE PRODUCT_TYPE_ID = '".$WFR."'";
$query = db::query($sql);
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
					<div class="col-md-12">
						<form action="../save/setup_product_type_save.php" method="POST">
							<input type="hidden" id="proc" name="proc" value="<?php echo $proc;?>">
							<input type="hidden" id="WFR" name="WFR" value="<?php echo $WFR;?>">
							 <div class="row">
								<div class="col-md-1"></div>	
								<div class="col-md-2">
									<label class="control-label">ชื่อผลิตภัณฑ์</label>
								</div>
								<div class="col-md-3">
									<input type="text" class="form-control" id="PRODUCT_TYPE_NAME" name="PRODUCT_TYPE_NAME" value="<?php echo $rec['PRODUCT_TYPE_NAME'];?>" >
								</div>
								<div class="col-md-1"></div>								
								<div class="col-md-2">
							 ...
							 <div class="row">
								<div class="col-md-12" align="center">
									...
									<a type="button" href="setup_product_type_disp.php" class="btn btn-danger btn-sm" title="">ยกเลิก</a>
								</div> <!-- /controls -->	
							</div> 
						</form>
					</div> 
