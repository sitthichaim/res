...
$sql = "SELECT * FROM M_SETUP_PRODUCT_TYPE WHERE ACTIVE_STATUS = 1 AND DELETE_FLAG = 0";
$query = db::query($sql);
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <div class="card-title">ประเภทผลิตภัณฑ์</div>
                </div>
                <div class="card-body">
                  <div class="row">
					<form id="frm_disp" action="../save/setup_product_type_save.php" method="POST">
						...
						<div class="table-responsive">
							<div class="row">
								<div class="col-md-12" align="right">
									<a class="btn btn-primary active btn-sm" href="setup_product_type_form.php" role="button" title=""><i class="icon-add"></i> เพิ่มข้อมูล</a>
								</div>
							</div>
							<table cellspacing="0" id="tbl" class="table table-vcenter table-mobile-md card-table">
								...
								if($num > 0){ 
									...
									while($rec = db::fetch_array($query)){
										$edit = '<a href="setup_product_type_form.php?WFR='.$rec['PRODUCT_TYPE_ID'].'" class="btn btn-warning btn-sm" title=""><i class="icofont icofont-tick-mark"></i>แก้ไข</a> &nbsp;'; 
										$del = '<a href="#!" class="btn btn-danger btn-sm" title="" onclick=delete_wf_main('.$rec['SA_ID'].')><i class="icofont icofont-trash"></i>ลบ</a>';
										echo "<tr>";
										echo "<td class='text-center'>".$i."</td>";
										echo "<td class='text-center'>".$rec['PRODUCT_TYPE_NAME']."</td>";
