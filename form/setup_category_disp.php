...
$sql = "SELECT * FROM M_CATEGORY WHERE ACTIVE_STATUS = 1 AND DELETE_FLAG = 0";
$query = db::query($sql);
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
					<form id="frm_disp" action="../save/setup_category_save.php" method="POST">
							...
							<table cellspacing="0" id="tbl" class="table table-vcenter table-mobile-md card-table">
								<thead">
									<tr>
										...
										<th style="width:15%;" class="text-center">ชื่อประเภท</th>
								...
								if($num > 0){ 
									...
									while($rec = db::fetch_array($query)){
										$edit = '<a href="setup_category_form.php?WFR='.$rec['CATEGORY_ID'].'" class="btn btn-warning btn-sm" title=""><i class="icofont icofont-tick-mark"></i>แก้ไข</a> &nbsp;'; 
										$del = '<a href="#!" class="btn btn-danger btn-sm" title="" onclick=delete_wf_main('.$rec['SA_ID'].')><i class="icofont icofont-trash"></i>ลบ</a>';
										echo "<tr>";
										echo "<td class='text-center'>".$i."</td>";
										echo "<td class='text-center'>".$rec['CATEGORY_NAME']."</td>";
